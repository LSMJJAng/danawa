...
public class mizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.addItem(new Product("미즈노 레뷸라컵 JP", "239,000" , "발볼 등급 : D", R.drawable.birdmissile1));
        adapter.addItem(new Product("미즈노 레뷸라컵 셀렉트", "83,000" , "발볼 등급 : D", R.drawable.birdmissile1));
        adapter.addItem(new Product("미즈노 레뷸라3 엘리트", "195,000" , "발볼 등급 : D", R.drawable.birdmissile1));
        adapter.addItem(new Product("미즈노 레뷸라컵 프로", "119,000" , "발볼 등급 : D", R.drawable.birdmissile1));
        adapter.addItem(new Product("미즈노 모렐리아네오3 프로", "139,000" , "발볼 등급 : E", R.drawable.birdmissile1));
        adapter.addItem(new Product("미즈노 모렐리아네오3 엘리트", "183,000" , "발볼 등급 : E", R.drawable.birdmissile1));
        adapter.addItem(new Product("미즈노 모렐리아네오3 베타", "293,000" , "발볼 등급 : E", R.drawable.birdmissile1));
        adapter.addItem(new Product("미즈노 모렐리아네오3 베타엘리트", "234,000" , "발볼 등급 : E", R.drawable.birdmissile1));
        adapter.addItem(new Product("미즈노 모렐리아 UL", "279,000" , "발볼 등급 : E", R.drawable.birdmissile1));
        adapter.addItem(new Product("미즈노 웨이브컵 레전드", "219,000" , "발볼 등급 : E", R.drawable.birdmissile1));
